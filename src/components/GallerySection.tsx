...
const albums: Album[] = [
  ...
  },
  {
    ...
    cover: network1,
    photos: [
      { src: network1, caption: "Network wiring task 1", date: "February 1, 2025" },
      { src: network2, caption: "Network wiring task 2", date: "February 3, 2025" },
      { src: network3, caption: "Network wiring task 3", date: "February 4, 2025" },
      { src: network4, caption: "Network wiring task 4", date: "February 5, 2025" },
      { src: network5, caption: "Network wiring task 5", date: "February 6, 2025" },
      { src: network6, caption: "Network wiring task 6", date: "February 7, 2025" },
      { src: network7, caption: "Network wiring task 7", date: "February 10, 2025" },
      { src: network8, caption: "Network wiring task 8", date: "February 11, 2025" },
      { src: network9, caption: "Network wiring task 9", date: "February 12, 2025" },
      { src: network10, caption: "Network wiring task 10", date: "February 13, 2025" },
      { src: network11, caption: "Network wiring task 11", date: "February 14, 2025" },
      { src: network12, caption: "Network wiring task 12", date: "February 17, 2025" },
      { src: network14, caption: "Network wiring task 13", date: "February 18, 2025" },
      { src: network15, caption: "Network wiring task 14", date: "February 19, 2025" },
      { src: network16, caption: "Network wiring task 15", date: "February 20, 2025" },
      { src: network17, caption: "Network wiring task 16", date: "February 21, 2025" },
      { src: network18, caption: "Network wiring task 17", date: "February 24, 2025" },
      { src: network19, caption: "Network wiring task 18", date: "February 25, 2025" },
      { src: network20, caption: "Network wiring task 19", date: "February 26, 2025" },
      { src: network21, caption: "Network wiring task 20", date: "February 28, 2025" },
    ],
  },
  {
    title: "Data Encoding",
